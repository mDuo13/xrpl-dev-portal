// Watch this address for transactions and look for gaps
const ADDRESS = 'rUCzEr6jrEyMpjhs4wSdQdz4g8Y382NxfM'
...
socket.addEventListener('message', (event) => {
  ...
  if (parsed_data.type === "transaction") {
    lookOutForGaps(parsed_data)
  }
})
