...
Withdraw assets from an [Automated Market Maker](../../../../concepts/tokens/automated-market-makers.md) (AMM) instance by returning the AMM's liquidity provider tokens (LP Tokens).
...
Transactions of the AMMWithdraw type support additional values in the [`Flags` field](../transaction-common-fields.md#flags-field), as follows:
...
| `tecFROZEN`             | The transaction tried to withdraw a [frozen](../../../../concepts/tokens/freezes.md) token. |
