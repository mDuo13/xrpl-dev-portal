...
Transactions of the NFTokenMint type support additional values in the [`Flags` field](../transaction-common-fields.md#flags-field), as follows:
...
| `tfTrustLine` | `0x00000004` | 4 | **DEPRECATED** Automatically create [trust lines](../../../../concepts/tokens/trust-lines-and-issuing.md) from the issuer to hold transfer fees received from transferring the minted `NFToken`. The [fixRemoveNFTokenAutoTrustLine amendment][] makes it invalid to set this flag. |
