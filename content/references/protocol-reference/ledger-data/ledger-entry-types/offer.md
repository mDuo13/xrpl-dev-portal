...
The `Offer` ledger entry describes an [Offer](../../../../concepts/tokens/offers.md) to exchange currencies in the XRP Ledger's [decentralized exchange](../../../../concepts/tokens/decentralized-exchange.md). (In finance, this is more traditionally known as an _order_.) An [OfferCreate transaction](../../transactions/transaction-types/offercreate.md) only creates an `Offer` entry in the ledger when the Offer cannot be fully executed immediately by consuming other Offers already in the ledger.
...
| `Sequence`          | Number           | UInt32            | Yes       | The `Sequence` value of the [OfferCreate](../../transactions/transaction-types/offercreate.md) transaction that created this offer. Used in combination with the `Account` to identify this offer. |
...
| Flag Name    | Hex Value    | Decimal Value | Corresponding [OfferCreate Flag](../../transactions/transaction-types/offercreate.md#offercreate-flags) | Description |
|--------------|--------------|---------------|-------------|------------------------|
...
* The Sequence number of the [OfferCreate transaction](../../transactions/transaction-types/offercreate.md) that created the Offer.

    If the OfferCreate transaction used a [Ticket](../../../../concepts/transactions/tickets.md), use the `TicketSequence` value instead.
