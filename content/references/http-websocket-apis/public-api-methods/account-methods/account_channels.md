...
| `channel_id`          | String           | A unique ID for this channel, as a 64-character hexadecimal string. This is also the [ID of the channel object](../../../protocol-reference/ledger-data/ledger-entry-types/paychannel.md#paychannel-id-format) in the ledger's state data. |
