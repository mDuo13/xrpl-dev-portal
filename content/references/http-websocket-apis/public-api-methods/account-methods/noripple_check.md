...
The `noripple_check` command provides a quick way to check the status of [the Default Ripple field for an account and the No Ripple flag of its trust lines](../../../../concepts/tokens/rippling.md), compared with the recommended settings.
...
| `transactions` | Boolean                    | _(Optional)_ If `true`, include an array of suggested [transactions](../../../protocol-reference/transactions/transaction-formats.md), as JSON objects, that you can sign and submit to fix the problems. Defaults to false. |
...
| `transactions`         | Array  | (May be omitted) If the request specified `transactions` as `true`, this is an array of JSON objects, each of which is the JSON form of a [transaction](../../../protocol-reference/transactions/transaction-formats.md) that should fix one of the described problems. The length of this array is the same as the `problems` array, and each entry is intended to fix the problem described at the same index into that array. |
