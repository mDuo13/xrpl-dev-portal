...
Each object in the `account_nfts` array represents one [NFToken](../../../protocol-reference/data-types/nftoken.md) and has the following fields:

| `Field`        | Type                 | Description                          |
|:---------------|:---------------------|:-------------------------------------|
| `Flags`        | Number               | A bit-map of boolean flags enabled for this NFToken. See [NFToken Flags](../../../protocol-reference/data-types/nftoken.md#nftoken-flags) for possible values. |
...
| `NFTokenTaxon` | Number               | The unscrambled version of this token's [taxon](../../../protocol-reference/data-types/nftoken.md#nftokentaxon). Several tokens with the same taxon might represent instances of a limited series. |
