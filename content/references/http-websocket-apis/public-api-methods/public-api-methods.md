...
By default, the following methods are [admin-only](../admin-api-methods/admin-api-methods.md). They can be used as public methods if the server admin has [enabled public signing](../../../infrastructure/rippled/configuration/enable-public-signing.md).
