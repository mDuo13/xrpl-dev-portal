...
The `submit` method applies a [transaction](../../../protocol-reference/transactions/transaction-formats.md) and sends it to the network to be confirmed and included in future ledgers.
...
|:------------|:--------|:----------|:-----------------------------------------------------|
| `tx_blob`   | String  | Yes       | Hex representation of the signed transaction to submit. This can be a [multi-signed transaction](../../../../concepts/transactions/multi-signing.md). |
...
This mode signs a transaction and immediately submits it. This mode is intended to be used for testing. You cannot use this mode for [multi-signed transactions](../../../../concepts/transactions/multi-signing.md).

_By default, sign-and-submit mode is [admin-only](../../admin-api-methods/admin-api-methods.md)._ It can be used as a public method if the server has [enabled public signing](../../../../infrastructure/rippled/configuration/enable-public-signing.md).
...
|:---------------|:--------|:--------------------------------------------------|
| `tx_json`      | Object  | [Transaction definition](../../../protocol-reference/transactions/transaction-formats.md) in JSON format, optionally omitting any auto-fillable fields. |
...
| `Field`                 | Type    | Description                              |
|:------------------------|:--------|:-----------------------------------------|
| `engine_result`         | String  | Text [result code](../../../protocol-reference/transactions/transaction-results/transaction-results.md) indicating the preliminary result of the transaction, for example `tesSUCCESS` |
| `engine_result_code`    | Integer | Numeric version of the [result code](../../../protocol-reference/transactions/transaction-results/transaction-results.md). **Not recommended.** |
