...
The `nft_buy_offers` method returns a list of buy offers for a given [NFToken](../../../protocol-reference/data-types/nftoken.md) object.
...
|:---------------|:-----------------|:-----------------------------------------|
| `nft_id`       | String           | The unique identifier of a [NFToken](../../../protocol-reference/data-types/nftoken.md) object. |
