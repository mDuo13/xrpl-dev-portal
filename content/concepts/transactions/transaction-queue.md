...
The transaction queue plays an important role in selecting the transactions that are included or excluded from a given ledger version in the consensus process. The following steps describe how the transaction queue relates to the [consensus process](../consensus-protocol/consensus.md).
...
- Transactions must be properly-formed and [authorized](transactions.md#authorizing-transactions) with valid signatures.
...
- [Consensus](../consensus-protocol/consensus.md) for a detailed description of how the consensus process approves transactions.
