...
- All [fields of a transaction](../../references/protocol-reference/transactions/transaction-common-fields.md) are signed, except the signature itself.
- The key pair(s) used to sign the transaction are [authorized to send transactions on behalf of that account](transactions.md#authorizing-transactions).
...
- **References:**
    - [Basic Data Types - Hashes](../../references/protocol-reference/data-types/basic-data-types.md#hashes)
    - [Transaction Common Fields - Global Flags](../../references/protocol-reference/transactions/transaction-common-fields.md#global-flags)
    - [Transaction Results](../../references/protocol-reference/transactions/transaction-results/transaction-results.md)
    - [Serialization Format](../../references/protocol-reference/serialization.md)
