...
Auto-bridging happens automatically on any [OfferCreate transaction](../../references/protocol-reference/transactions/transaction-types/offercreate.md). [Payment transactions](../../references/protocol-reference/transactions/transaction-types/payment.md) _do not_ use auto-bridging by default, but path-finding can find [paths](paths.md) that have the same effect.
