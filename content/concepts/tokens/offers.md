...
In the XRP Ledger's [decentralized exchange](decentralized-exchange.md), trade orders are called "Offers". Offers can trade XRP with [tokens](tokens.md), or tokens for other tokens, including tokens with the same currency code but different issuers. (Tokens with the same code but different issuers can also sometimes be exchanged through [rippling](rippling.md).)

- To create an Offer, send an [OfferCreate transaction](../../references/protocol-reference/transactions/transaction-types/offercreate.md).
- Offers that aren't fully filled immediately become [Offer objects](../../references/protocol-reference/ledger-data/ledger-entry-types/offer.md) in the ledger data. Later Offers and Payments can consume the Offer object from the ledger.
...
- If the sell asset is a token in a [frozen trust line](freezes.md).
...
The limit values of [trust lines](trust-lines-and-issuing.md) do not affect Offers. In other words, you can use an Offer to acquire more than the maximum amount you trust an issuer for.
...
- **References:**
    ...
    - [OfferCreate transaction](../../references/protocol-reference/transactions/transaction-types/offercreate.md)
    - [OfferCancel transaction](../../references/protocol-reference/transactions/transaction-types/offercancel.md)
    - [Offer object](../../references/protocol-reference/ledger-data/ledger-entry-types/offer.md)
