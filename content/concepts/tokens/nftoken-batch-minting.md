...
Use a program or script to mint many tokens at once. You might find that [Tickets](../transactions/tickets.md) help you submit transactions in parallel, up to a current limit of 200 transactions in one group.
