...
3. The customer sends a [TrustSet transaction](../../references/protocol-reference/transactions/transaction-types/trustset.md) to create a trust line to the issuer's address, with a positive limit.
