...
For more information on Transactions, see [Transactions](../transactions/transactions.md).
...
```
For information on the fields in an Account record, see [Accounts](../accounts/accounts.md).
