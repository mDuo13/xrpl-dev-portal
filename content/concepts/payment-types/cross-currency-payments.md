...
- There must be at least one [Path](../tokens/paths.md) between the sender and receiver, and the total liquidity across all paths must be enough to execute the payment. Cross-currency payments convert from one currency to another by consuming [Offers](../tokens/offers.md) in the XRP Ledger's [decentralized exchange](../tokens/decentralized-exchange.md).
...
For more information, see [Auto-Bridging](../tokens/autobridging.md).
...
- **Concepts:**
    ...
    - [Decentralized Exchange](../tokens/decentralized-exchange.md)
    - [Paths](../tokens/paths.md)
- **References:**
    ...
    - [Interpreting Metadata of Cross-Currency Payments](../transactions/look-up-transaction-results.md#token-payments)
