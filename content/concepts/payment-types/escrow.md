...
The additional transaction cost required is proportional to the size of the fulfillment. If the transaction is [multi-signed](../transactions/multi-signing.md), the cost of multi-signing is added to the cost of the fulfillment.

Currently, an EscrowFinish with a fulfillment requires a minimum transaction cost of **330 [drops of XRP](../../references/protocol-reference/data-types/basic-data-types.md#specifying-currency-amounts) plus 10 drops per 16 bytes in the size of the fulfillment**.
...
- [Transaction Reference](../../references/protocol-reference/transactions/transaction-formats.md)
...
- [Ledger Reference](../../references/protocol-reference/ledger-data/ledger-data-formats.md)
    - [Escrow object](../../references/protocol-reference/ledger-data/ledger-entry-types/escrow.md)
