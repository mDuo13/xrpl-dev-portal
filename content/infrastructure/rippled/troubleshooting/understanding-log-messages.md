...
This is not strictly a problem, but an old server version is likely to become [amendment blocked](../../../concepts/networks-and-servers/amendments.md#amendment-blocked-servers). You should [update `rippled`](install-rippled.html) to the latest stable version. (If you are connected to [devnet](../../../concepts/networks-and-servers/parallel-networks.md), update to the latest nightly version instead.)
...
This indicates that your server is having trouble requesting specific ledger data from its peers. If the [ledger index](../../../references/protocol-reference/data-types/basic-data-types.md#ledger-index) is much lower than the most recent validated ledger's index as reported by the [server_info method](../../../references/http-websocket-apis/public-api-methods/server-info-methods/server_info.md), this probably indicates that your server is downloading a [history shard](../../../concepts/networks-and-servers/ledger-history/history-sharding.md).
...
This is normal if your server is syncing, backfilling, or downloading [history shards](../../../concepts/networks-and-servers/ledger-history/history-sharding.md).
...
Messages such as the following are caused by a bug in `rippled` v1.1.0 and earlier when downloading historical ledgers for [history sharding](../../../concepts/networks-and-servers/ledger-history/history-sharding.md):
...
Messages such as the following occur when [online deletion is interrupted](../../../concepts/networks-and-servers/ledger-history/online-deletion.md#interrupting-online-deletion):
...
This message indicates that [online deletion](../../../concepts/networks-and-servers/ledger-history/online-deletion.md) has started running:
...
| `lastRotated`    | [Ledger Index][] | The end of the ledger range in the ["old" (read-only) database](../../../concepts/networks-and-servers/ledger-history/online-deletion.md#how-it-works). Online deletion deletes this ledger version and earlier. |
| `deleteInterval` | Number           | How many ledger versions to keep after online deletion. The [`online_delete` setting](../../../concepts/networks-and-servers/ledger-history/online-deletion.md#configuration) controls this value. |
| `canDelete_`     | [Ledger Index][] | The newest ledger version that the server is allowed to delete, if using [advisory deletion](../../../concepts/networks-and-servers/ledger-history/online-deletion.md#advisory-deletion). If not using advisory deletion, this value is ignored. |
...
Log messages such as the following can occur when you have [history sharding](../../../concepts/networks-and-servers/ledger-history/history-sharding.md) enabled:
