...
In its default configuration, [the `rippled` server](xrpl-servers.html) [deletes history](../../../concepts/networks-and-servers/ledger-history/online-deletion.md) older than the most recent 2000 [ledger versions](../../../concepts/ledgers/ledgers.md), keeping approximately 15 minutes of [ledger history](../../../concepts/networks-and-servers/ledger-history/ledger-history.md) (based on the current rate between ledgers). This page describes how to configure the amount of history your `rippled` server stores before deleting.
...
- The `rippled` server is already [installed](install-rippled.html) and [online deletion](../../../concepts/networks-and-servers/ledger-history/online-deletion.md) is enabled.
...
0. Monitor your `rippled` logs for messages that begin with `SHAMapStore::WRN`. This can indicate that [online deletion is being interrupted](../../../concepts/networks-and-servers/ledger-history/online-deletion.md#interrupting-online-deletion) because your server fell out of sync with the network.
