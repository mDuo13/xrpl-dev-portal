...
[History Sharding](../../../concepts/networks-and-servers/ledger-history/history-sharding.md) lets servers contribute to preserving historical XRP Ledger data without each server needing to store the full history. By default, `rippled` servers do not store history shards.
